/**
 * Collector agent: readiness (contact/answers/classification) and ROI (calculator/metadata/benefits).
 * buildSystemPrompt, parsePayload, stripPayloadForDisplay, computeCompletion (readiness only).
 */
